...
{
    public class CreateMemberAdditionalInformationDto
    {
    ...
    public class UpdateMemberAdditionalInformationDto : CreateMemberAdditionalInformationDto
    {
        public int Id { get; set; }
    }

    public class MemberAdditionalInformationDto : UpdateMemberAdditionalInformationDto
    {
        public bool IsInformationConfirmed { get; set; }
